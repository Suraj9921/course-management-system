package com.technest.learning_management_system.utility;


import com.technest.learning_management_system.dao.*;
import com.technest.learning_management_system.entity.*;
...
//        fetchCoursesForStudent(courseDao);
    ...
    private static void fetchCoursesForStudent(CourseDao courseDao) {
        courseDao.getCoursesByStudentId(1L, Pageable.unpaged()).forEach(course -> System.out.println(course.toString()));
    }
